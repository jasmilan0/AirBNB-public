          ...
          addedPhotos.map((link) => (
            ...
            <div className="h-32 flex relative" key={link}>
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 right-1 text-black bg-gray-100 rounded-2xl px-3 py-2"
              >
                <svg
              ...
              <button
                ...
                className="cursor-pointer absolute bottom-1 left-1 text-black bg-gray-100 rounded-2xl px-3 py-2"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
